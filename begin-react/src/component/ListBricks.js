...
function CreateBrick({
    ...
    return (
        <div>
            ...
            <input
                type="text"
                placeholder="ex. nth Avenue at nth St"
                name="address"
                value={address}
                onChange={changeEvent}
            />
            <button
                type="button"
                onClick={createEvent}
                style={Object.assign(btnStyleClone, uiElemStyle)}
            >
                Add
            </button>
        </div>
    ...
    return (
        <li data-index={id} style={itemStyle}>
            <strong
                ...
                style={Object.assign(activeStyle, uiElemStyle)}
            >
                {name}
            </strong>
            {" leave in "}
...
function ListBricks() {
    ...
    const activebrickItemCount = useMemo(
        () => userInfo.filter(info => info.leave).length,
        [userInfo],
    );
